...
<div class="panel panel-container">
    ...
    <form role="form" style="margin: 20px" action="/dashboard" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <label>Gambar</label>
            <input type="file" class="form-control-file" name="gambar" value="{{ old('gambar') ? old('gambar') :$produk ->gambar }}">
                @error("gambar")
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
        </div>
